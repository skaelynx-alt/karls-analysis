...
Before discussing the detailed findings, it is important to note that an additional 10 participants were incorporated after the preliminary analysis had been completed. This led to several minor changes in the dataset and modelling results compared with the original 100-participant analysis. The sample size increased from 100 to 110 participants, leading to small changes in descriptive statistics, treatment group proportions, and several estimated model coefficients. In the updated dataset, rs123456, which previously showed the same genotype across all participants, displayed variation and was therefore retained in the SNP screening stage rather than excluded as a zero-variance variable. An additional SNP candidate (rs26922) also met the nominal screening threshold for the AF outcome and was carried forward into the SNP-augmented model. Despite these updates, the overall modelling strategy, model selection decisions, and substantive conclusions were unchanged: the treatment effect on AF remained strong and statistically robust, evidence for treatment differences in PR remained comparatively weaker after age adjustment, and neither SNP contributed meaningfully to model performance.

The detailed interpretation of the updated models is discussed below.
